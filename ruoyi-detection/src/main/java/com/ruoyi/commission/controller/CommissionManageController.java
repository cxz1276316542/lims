...
{
    @Autowired
    private ICommissionManageService commissionService;
    ...
    public AjaxResult getReviewSuggestion(long sampleId){
        String review = commissionService.getReview(sampleId);
