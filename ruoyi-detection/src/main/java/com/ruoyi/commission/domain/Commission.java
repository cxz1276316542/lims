...
public class  Commission extends BaseEntity
{
    ...
    @Excel(name = "检测要求名称")
        private String detectionDescriptionInfo;


    public String getDetectionDescriptionInfo() {
        return detectionDescriptionInfo;
    }

    public void setDetectionDescriptionInfo(String detectionDescriptionInfo) {
        this.detectionDescriptionInfo = detectionDescriptionInfo;
    }

    public Commission(){};

    public Commission(EntrustList entrustList){
        ...
        sampleDistribute = 0;
        sign = 1L;
        detectionDescription = entrustList.getDetectionDescription();
    }
