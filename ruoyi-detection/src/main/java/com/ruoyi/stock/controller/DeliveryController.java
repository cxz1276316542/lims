...
public class DeliveryController extends BaseController
{
    ...
    {
        entryAndOutVO.setEntryAndOutCategory(StockConstants.CATEGORY_DELIVERY);
    ...
    @GetMapping("/export")
    public AjaxResult export(EntryAndOutVO entryAndOut)
    {
        entryAndOut.setEntryAndOutCategory(StockConstants.CATEGORY_DELIVERY);
        List<EntryAndOut> list = (List<EntryAndOut>)entryAndOutService.selectEntryAndOutList(entryAndOut).getRows();
