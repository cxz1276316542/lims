...
export function getTaskAssignListVO(query) {
  return request({
    url: '/detection/taskAssign/listReassignVO',
    method: 'get',
    params: query
  })
}
...
// 查询到单个任务分派信息
export function getTaskAssignInfo(taskAssignID) {
  return request({
    url: '/detection/taskAssign/taskAssignInfo/'+ taskAssignID,
    method: 'get'
  })
}
...
// 修改单个检测项目
export function updateTaskAssignInfo(data) {
  return request({
    url: '/detection/taskAssign/updateDetectionItem',
    method: 'put',
    data: data
  })
}
