  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" width="1200px">
              ...
              <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item command="handleUpdate" icon="el-icon-edit"
                    v-hasPermi="['system:user:edit']">修改客户</el-dropdown-item>
                  <el-dropdown-item command="handleDelete" icon="el-icon-delete"
                    v-hasPermi="['system:user:remove']">删除客户</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm('确认要"' + text + '""' + row.userName + '"客户吗?', "警告", {
    ...
    handleAuthRole: function(row) {
      ...
      this.$router.push("/user/addressMan/" + userId);
    },
    /** 提交按钮 */
    submitForm: function() {
